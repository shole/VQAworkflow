...
for vqafile in vqafiles:
	...
	for file in filelist:
		...
		sequencename="seq_"+str(framecounter).zfill(8)+".png"
...
f = open('vqa2seq.pickle','wb')
pickle.dump(framecorrespondence,f)
